...
<head>
    <title>Perfect World DevRev</title>
      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
      <meta http-equiv="X-UA-Compatible" content="IE=edge" />
      <meta name="description" content="Projeto de estudos feito em JSP." />
      <meta name="author" content="Breno Silva Xavier de Souza" />
      <!-- Favicon icon -->
      <link rel="icon" href="<%= request.getContextPath() %>/images/pwicon.png" type="image/x-icon">
    <!-- Google font-->
